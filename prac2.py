...
heuristics = {
    ...
    'Oradea': 380, 'Lugoj': 244, 'Fagaras': 176, 'Rimnicu Vilcea': 193,
    'Mehadia': 241, 'Drobeta': 242, 'Craiova': 160, 'Pitesti': 100, 'Bucharest': 0
}
...
def rbfs_search(start, goal, path, f_limit):
    ...
    for city in sorted_successors:
        new_path, f_value = path + [city], successors[city] + heuristics[city]
        if f_value > f_limit:
            return None
